...
input_path <- "/work/triffid/prasanth/reorganizing-irb-scripts/plant-phenotypes-nlp/quoats/plots/combined_plot_data.csv"
output_path <- "/work/triffid/prasanth/reorganizing-irb-scripts/plant-phenotypes-nlp/figs/tool_query_bargraphs.pdf"
...
ggsave(output_path, plot=last_plot(), device="pdf", path=NULL, scale=1, width=33, height=7, units=c("cm"), dpi=350, limitsize=FALSE)
