...
input_path <- "/work/triffid/prasanth/reorganizing-irb-scripts/plant-phenotypes-nlp/outputs/stacked_05_02_2023_h14m52s44_8825/stacked_f1_max.csv"
...
ggsave(output_path, plot=last_plot(), device="pdf", path=NULL, scale=1, width=16, height=5, units=c("cm"), dpi=350, limitsize=FALSE)
